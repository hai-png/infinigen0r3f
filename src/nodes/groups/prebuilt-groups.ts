 ...
 */
export function createNoiseDisplacementGroup(
  name: string = 'NoiseDisplacement',
  scale: number = 5,
  detail: number = 2,
  strength: number = 1
): NodeWrangler {
 ...
 */
export function createPrincipledMaterialGroup(
  name: string = 'PrincipledMaterial',
  baseColor: [number, number, number, number] = [0.8, 0.8, 0.8, 1],
 ...
 */
export function createRandomDistributionGroup(
  name: string = 'RandomDistribution',
  min: number = 0,
  max: number = 1,
  seed: number = 0
): NodeWrangler {
 ...
 */
export function createInstanceOnPointsGroup(
  name: string = 'InstanceOnPoints',
  rotateInstances: boolean = true,
  scaleInstances: boolean = true
): NodeWrangler {
  const nw = createGeometryNodeTree(name);
 ...
 */
export function createMeshBooleanGroup(
  name: string = 'MeshBoolean',
 ...
 */
export function createTextureMappingGroup(
  name: string = 'TextureMapping',
 ...
 */
export function createColorRampGroup(
  name: string = 'ColorRampMapper',
