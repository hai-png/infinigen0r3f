...
export class BoulderGenerator {
   ...
   */
  private createBoulderGeometry(): THREE.BufferGeometry {
   ...
   */
  private makeRound(geometry: THREE.BufferGeometry, positions: Float32Array): void {
   ...
   */
  private makeAngular(geometry: THREE.BufferGeometry, positions: Float32Array): void {
   ...
   */
  private makeFlat(geometry: THREE.BufferGeometry, positions: Float32Array): void {
   ...
   */
  private makeIrregular(geometry: THREE.BufferGeometry, positions: Float32Array, normals: Float32Array): void {
   ...
   */
  private makeWeathered(geometry: THREE.BufferGeometry, positions: Float32Array, normals: Float32Array): void {
   ...
   */
  private applyDisplacement(geometry: THREE.BufferGeometry, positions: Float32Array, normals: Float32Array): void {
   ...
   */
  private createBoulderMaterial(): THREE.MeshStandardMaterial {
   ...
   */
  private getMaterialColor(type: BoulderMaterial): THREE.Color {
    const colors: Record<BoulderMaterial, THREE.Color> = {
