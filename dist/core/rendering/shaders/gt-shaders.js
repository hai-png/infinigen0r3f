...
export class GTFlatShadingMaterial extends ShaderMaterial {
     ...
     */
    generateRandomColor(instanceId) {
...
export class GTPositionMaterial extends ShaderMaterial {
    constructor(scale = 1.0, offset = new Vector3(0, 0, 0)) {
        super({
            uniforms: {
...
export class GTAlbedoMaterial extends ShaderMaterial {
    constructor(baseColor = new Color(1, 1, 1)) {
        super({
            uniforms: {
...
export class GTEmissionMaterial extends ShaderMaterial {
    constructor(emissive = new Color(0, 0, 0)) {
        super({
            uniforms: {
 ...
 */
export function createGTMaterial(passType, params) {
 ...
 */
export function applyGTMaterialsToScene(scene, passType, params) {
...
//# sourceMappingURL=gt-shaders.js.map