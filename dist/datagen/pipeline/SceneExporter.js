...
export class SceneExporter {
     ...
     */
    async initializeDraco(dracoPath) {
     ...
     */
    exportMTLMaterial(material, index) {
     ...
     */
    async generateLODs(object, config) {
     ...
     */
    reduceGeometryDetail(object, reduction) {
     ...
     */
    async packTextures(materials, atlasSize = 4096) {
     ...
     */
    download(result, customFilename) {
...
//# sourceMappingURL=SceneExporter.js.map