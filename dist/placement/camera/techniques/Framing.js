...
(function (ShotSize) {
    ...
    ShotSize["MEDIUM_CLOSE_UP"] = "medium_close_up";
    ShotSize["MEDIUM_SHOT"] = "medium_shot";
    ShotSize["MEDIUM_LONG_SHOT"] = "medium_long_shot";
    ShotSize["LONG_SHOT"] = "long_shot";
    ShotSize["VERY_LONG_SHOT"] = "very_long_shot";
    ShotSize["EXTREME_LONG_SHOT"] = "extreme_long_shot";
})(ShotSize || (ShotSize = {}));
...
export function calculateDistanceForShot(shotSize, subjectHeight, focalLength, sensorHeight) {
...
export function frameSubject(camera, subjectBox, shotSize, padding = 0.1) {
    const subjectSize = subjectBox.getSize(new THREE.Vector3());
    const subjectCenter = subjectBox.getCenter(new THREE.Vector3());
    const distance = calculateDistanceForShot(shotSize, subjectSize.y, camera instanceof THREE.PerspectiveCamera ? camera.fov : 50, 24);
