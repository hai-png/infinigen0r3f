...
export class TerrainMesher {
     ...
     */
    generateChunkedMesh(terrainData, cameraPosition) {
     ...
     */
    generateChunk(terrainData, chunkX, chunkY, lodLevel) {
     ...
     */
    updateChunks(terrainData, cameraPosition) {
...
//# sourceMappingURL=TerrainMesher.js.map