...
export class WaterBody {
    constructor(params = {}) {
        ...
        this.geometry = new THREE.PlaneGeometry(this.params.surfaceSize.x, this.params.surfaceSize.y, this.params.resolution, this.params.resolution);
     ...
     */
    generateShoreline(terrainGeometry) {
        this.shorelinePoints = [];
...
//# sourceMappingURL=WaterBody.js.map