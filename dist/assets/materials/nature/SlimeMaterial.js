...
export class SlimeMaterial {
     ...
     */
    static generateSlimeTexture(ctx, size, config) {
        // Base color gradient
     ...
     */
    static generateIridescenceTexture(ctx, size, config) {
     ...
     */
    static addBubbles(ctx, size, config) {
