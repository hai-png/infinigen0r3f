...
export class MetalGenerator extends BaseMaterialGenerator {
    ...
    generateBrushedNormal(params, rng) {
        const size = 512;
    ...
    applyOxidation(material, params, rng) {
    ...
    getVariations(count) {
        const variations = [];
        const types = ['steel', 'aluminum', 'brass', 'copper', 'iron'];
...
//# sourceMappingURL=MetalGenerator.js.map