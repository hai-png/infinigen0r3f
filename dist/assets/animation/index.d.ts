...
export { OscillatoryMotion, PatternGenerator, evaluateWave, createPresetMotion, createPresetPattern } from './motion/OscillatoryMotion';
export type { WaveType, OscillatoryConfig, PatternType, PatternConfig } from './motion/OscillatoryMotion';
export { PathFollower, generateCameraPath } from './motion/PathFollowing';
export type { SplineType, OrientationMode, SplineKeyframe, PathFollowingConfig, PathSample } from './motion/PathFollowing';
export { WindAnimationSystem, WindZone } from './motion/WindAnimationSystem';
export type { WindLayer, WindParams, AnimationConfig } from './motion/WindAnimationSystem';
