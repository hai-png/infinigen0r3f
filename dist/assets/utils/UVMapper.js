...
export class UVMapper {
     ...
     */
    static generatePlanarUVs(geometry, axis = 'z') {
     ...
     */
    static generateSphericalUVs(geometry) {
        const positions = geometry.attributes.position.array;
     ...
     */
    static generateCylindricalUVs(geometry, axis = 'y') {
        const positions = geometry.attributes.position.array;
        const uvs = [];
        const box = new Box3();
        box.setFromBufferAttribute(geometry.attributes.position);
     ...
     */
    static generateBoxUVs(geometry) {
        const positions = geometry.attributes.position.array;
        const normals = geometry.attributes.normal?.array;
        const uvs = [];
        if (!normals) {
     ...
     */
    static autoGenerateUVs(geometry) {
...
//# sourceMappingURL=UVMapper.js.map