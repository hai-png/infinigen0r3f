...
export class CaveDecorations {
     ...
     */
    createStalactite() {
        const length = THREE.MathUtils.lerp(this.config.stalactiteLength[0], this.config.stalactiteLength[1], Math.random());
     ...
     */
    createStalagmite() {
        const height = THREE.MathUtils.lerp(this.config.stalagmiteHeight[0], this.config.stalagmiteHeight[1], Math.random());
     ...
     */
    createCrystal() {
        const size = THREE.MathUtils.lerp(this.config.crystalSize[0], this.config.crystalSize[1], Math.random());
    ...
    createColumn() {
        ...
        const mesh = new THREE.Mesh(new THREE.CylinderGeometry(0.15, 0.2, height, 7), material);
        mesh.castShadow = true;
        mesh.receiveShadow = true;
        return mesh;
    }
...
//# sourceMappingURL=CaveDecorations.js.map