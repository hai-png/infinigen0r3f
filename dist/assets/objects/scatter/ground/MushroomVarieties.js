 ...
 */
export var MushroomSpecies;
(function (MushroomSpecies) {
    // Edible
    MushroomSpecies["CHANTERELLE"] = "chanterelle";
    MushroomSpecies["PORCINI"] = "porcini";
    MushroomSpecies["MOREL"] = "morel";
    MushroomSpecies["HEN_OF_WOODS"] = "hen_of_woods";
    // Poisonous
    MushroomSpecies["AMANITA"] = "amanita";
    MushroomSpecies["DEATH_CAP"] = "death_cap";
    MushroomSpecies["FLY_AGARIC"] = "fly_agaric";
    // Common
    MushroomSpecies["BUTTON"] = "button";
    MushroomSpecies["OYSTER"] = "oyster";
    MushroomSpecies["SHITAKE"] = "shiitake";
    MushroomSpecies["PUFFBALL"] = "puffball";
    // Fantasy
    MushroomSpecies["BIOLUMINESCENT"] = "bioluminescent";
    MushroomSpecies["GHOST_FUNGUS"] = "ghost_fungus";
    MushroomSpecies["CRYSTAL_MUSHROOM"] = "crystal_mushroom";
})(MushroomSpecies || (MushroomSpecies = {}));
/**
 * Growth stage for decay progression
 */
export var GrowthStage;
(function (GrowthStage) {
    GrowthStage["YOUNG"] = "young";
    GrowthStage["MATURE"] = "mature";
    GrowthStage["AGING"] = "aging";
    GrowthStage["DECAYING"] = "decaying"; // Breaking down, dark colors
...
export class MushroomVarieties {
     ...
     */
    static generateMushroom(config) {
     ...
     */
    static createStem(species, sizeMultiplier) {
     ...
     */
    static createCap(species, stage, sizeMultiplier) {
     ...
     */
    static createIrregularCap(baseSize) {
     ...
     */
    static createCapSpots(cap, spotColor) {
        const group = new THREE.Group();
        ...
        for (let i = 0; i < spotCount; i++) {
            ...
            spot.position.set(radius * Math.sin(phi) * Math.cos(theta), radius * Math.cos(phi), radius * Math.sin(phi) * Math.sin(theta));
            group.add(spot);
        }
        return group;
    }
     ...
     */
    static addBioluminescence(group, glowColor, intensity) {
     ...
     */
    static createSporeCloud(species) {
     ...
     */
    static applyDecayColors(group, stage) {
     ...
     */
    static getGrowthStageMultiplier(stage) {
        switch (stage) {
     ...
     */
    static generateCluster(config, count) {
        const group = new THREE.Group();
     ...
     */
    static generateScattered(config) {
        const group = new THREE.Group();
...
MushroomVarieties.SPECIES_DATA = {
...
//# sourceMappingURL=MushroomVarieties.js.map