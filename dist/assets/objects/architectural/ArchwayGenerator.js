...
export class ArchwayGenerator extends BaseObjectGenerator {
    ...
    createRoundArch(group, params, material, segments) {
    ...
    createPointedArch(group, params, material, segments) {
    ...
    createSegmentalArch(group, params, material, segments) {
    ...
    createEllipticalArch(group, params, material, segments) {
        const halfWidth = params.width / 2;
    ...
    createParabolicArch(group, params, material, segments) {
        const halfWidth = params.width / 2;
        const archHeight = params.height * 0.6;
        const shape = new THREE.Shape();
        shape.moveTo(-halfWidth, 0);
    ...
    createTrefoilArch(group, params, material, segments) {
        const halfWidth = params.width / 2;
    ...
    createColumn(height, radius, style, material) {
...
//# sourceMappingURL=ArchwayGenerator.js.map