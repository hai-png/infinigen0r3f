...
export class PlateGenerator extends BaseObjectGenerator {
    constructor() {
        super(...arguments);
        this.defaultParams = {
            type: 'dinner',
    ...
    createRoundPlate(group, params, seed) {
    ...
    createSquarePlate(group, params, seed) {
        const material = this.getMaterial(params);
    ...
    createOvalPlate(group, params, seed) {
        const material = this.getMaterial(params);
    ...
    createRectangularPlate(group, params, seed) {
        const material = this.getMaterial(params);
...
//# sourceMappingURL=PlateGenerator.js.map