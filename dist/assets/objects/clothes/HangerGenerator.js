...
export class HangerGenerator {
    ...
    createHook() {
        ...
        if (this.params.hookStyle === 'standard') {
            // Simple J-hook
            const hookCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight + this.params.hookHeight, 0), new THREE.Vector3(0, this.params.shoulderHeight + this.params.hookHeight * 0.7, 0.05), new THREE.Vector3(0, this.params.shoulderHeight, 0.08));
            ...
            // Hook curve
            const hookCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight + this.params.hookHeight, 0), new THREE.Vector3(0, this.params.shoulderHeight + this.params.hookHeight * 0.6, 0.06), new THREE.Vector3(0, this.params.shoulderHeight + this.params.hookHeight * 0.3, 0.1));
            const hookGeometry = new THREE.TubeGeometry(hookCurve, 16, 0.015, 8, false);
            const hook = new THREE.Mesh(hookGeometry, hookMaterial);
            this.group.add(hook);
        }
            ...
            const hookCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0.02, this.params.shoulderHeight + this.params.hookHeight, 0), new THREE.Vector3(0.03, this.params.shoulderHeight + this.params.hookHeight * 0.7, 0.04), new THREE.Vector3(0.02, this.params.shoulderHeight, 0.08));
            const hookGeometry = new THREE.TubeGeometry(hookCurve, 16, 0.015, 8, false);
            const hook = new THREE.Mesh(hookGeometry, hookMaterial);
            this.group.add(hook);
        }
     ...
     */
    createStandardShoulder(material, halfWidth) {
     ...
     */
    createCurvedShoulder(material, halfWidth, thickness) {
        const curve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight, 0), new THREE.Vector3(halfWidth * 0.5, this.params.shoulderHeight * 0.95, 0.02), new THREE.Vector3(halfWidth, this.params.shoulderHeight * 0.8, 0.03));
        const geometry = new THREE.TubeGeometry(curve, 20, thickness, 8, false);
        // Left side
        const leftShoulder = new THREE.Mesh(geometry, material);
        this.group.add(leftShoulder);
        // Right side (mirrored)
        const rightCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight, 0), new THREE.Vector3(-halfWidth * 0.5, this.params.shoulderHeight * 0.95, 0.02), new THREE.Vector3(-halfWidth, this.params.shoulderHeight * 0.8, 0.03));
     ...
     */
    createContouredShoulder(material, halfWidth) {
        const points = [];
        const segments = 30;
     ...
     */
    createPaddedShoulder(material, halfWidth) {
        const paddingRadius = this.params.paddingThickness + 0.02;
        // Left padded arm
        const leftCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight, 0), new THREE.Vector3(halfWidth * 0.5, this.params.shoulderHeight * 0.95, 0.01), new THREE.Vector3(halfWidth, this.params.shoulderHeight * 0.85, 0.02));
        ...
        this.group.add(leftShoulder);
        // Right padded arm
        const rightCurve = new THREE.QuadraticBezierCurve3(new THREE.Vector3(0, this.params.shoulderHeight, 0), new THREE.Vector3(-halfWidth * 0.5, this.params.shoulderHeight * 0.95, 0.01), new THREE.Vector3(-halfWidth, this.params.shoulderHeight * 0.85, 0.02));
...
//# sourceMappingURL=HangerGenerator.js.map