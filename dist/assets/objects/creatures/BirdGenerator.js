...
export class BirdGenerator extends CreatureBase {
    ...
    generateBody(params) {
        ...
        const bodyGeometry = this.createEllipsoidGeometry(params.size * 0.3, params.size * 0.4, params.size * 0.2);
