...
export class StoolGenerator extends BaseObjectGenerator {
    constructor() {
        super();
    }
    getDefaultConfig() {
    ...
    generate(params = {}) {
        ...
        const collisionMesh = undefined; // this.generateCollisionMesh(group);
    ...
    createSingleLegGeometry(params, height, rng, isCenter = false) {
        let geometry;
    ...
    createFootrest(params, rng) {
        ...
        if (params.legType === 'four') {
            ...
            connectorPositions.forEach(pos => {
                ...
                const connector = new THREE.Mesh(connectorGeometry, material);
                connector.position.set(Math.cos(angle) * ringRadius, footrestHeight, Math.sin(angle) * ringRadius);
    ...
    createSwivelMechanism(params, rng) {
...
StoolGenerator.GENERATOR_ID = 'stool_generator';
// Auto-register on import
if (typeof window !== 'undefined') {
    new StoolGenerator().register();
}
export default StoolGenerator;
//# sourceMappingURL=StoolGenerator.js.map