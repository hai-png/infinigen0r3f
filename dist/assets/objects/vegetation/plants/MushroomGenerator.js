...
export class MushroomGenerator extends BaseObjectGenerator {
    getDefaultConfig() {
    ...
    createGills(config) {
        ...
        for (let i = 0; i < count; i++) {
            ...
            const gill = new THREE.Mesh(new THREE.PlaneGeometry(config.capSize * 0.8, 0.02), new THREE.MeshStandardMaterial({ color: 0xffc0cb, side: THREE.DoubleSide }));
...
//# sourceMappingURL=MushroomGenerator.js.map