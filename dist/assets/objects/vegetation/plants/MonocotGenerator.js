...
export const MonocotSpeciesPresets = {
    tall_grass: {
        height: 0.8,
        stemRadius: 0.003,
        leafLength: 1.0,
...
export class MonocotGenerator {
     ...
     */
    generateStem(offset = new THREE.Vector3()) {
        const group = new THREE.Group();
    ...
    createStemGeometry() {
        ...
        return new THREE.CylinderGeometry(topRadius, bottomRadius, height, Math.max(6, segments), segments, false);
    }
    /**
     ...
     */
    applyLeafDeformation(leaf, curvature, droop) {
     ...
     */
    generateField(count, areaSize, terrainHeightmap) {
        ...
        const geometry = stemMesh.geometry;
        const material = stemMesh.material;
...
//# sourceMappingURL=MonocotGenerator.js.map