...
export class LightingSystem {
     ...
     */
    setupSun() {
        const light = new THREE.DirectionalLight(this.config.sunColor, this.config.sunIntensity);
     ...
     */
    setupFillLight() {
        const light = new THREE.PointLight(this.config.ambientColor, this.config.fillLightIntensity);
     ...
     */
    setupRimLight() {
        const light = new THREE.SpotLight(this.config.ambientColor, this.config.rimLightIntensity);
 ...
 */
export function createIndoorLighting(scene, warm = true) {
    const lighting = new LightingSystem(scene, {
        preset: 'indoor',
