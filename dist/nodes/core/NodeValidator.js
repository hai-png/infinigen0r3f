...
export class NodeValidator {
     ...
     */
    validateLink(link, tree, targetNodeId) {
        const errors = [];
        const warnings = [];
     ...
     */
    validateOutputLink(link, tree, sourceNodeId) {
        const errors = [];
        const warnings = [];
     ...
     */
    areSocketsCompatible(sourceType, targetType) {
